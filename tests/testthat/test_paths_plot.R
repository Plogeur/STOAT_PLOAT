test_that("path_length_distribution Binary creates PNG plot from valid input file", {
...
# test_that("path_length_distribution Quantitative creates PNG plot from valid input file", {
#   # Locate test data file
